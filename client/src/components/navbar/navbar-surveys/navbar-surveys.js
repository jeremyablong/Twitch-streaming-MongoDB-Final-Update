...
import "./navbar-surveys.css";
import { Link } from "react-router-dom";
import { connect } from "react-redux";
import Payments from "../../stripe-payments/payments.js";
import { Collapse, Navbar, NavbarToggler, NavbarBrand, Nav, NavItem, NavLink } from 'reactstrap';
import MainContentDashboard from "./surveys-container/main-content.js";

class NavbarSurveys extends Component {
constructor(props) {
    super(props);
          ...
          default:
          	return (
		         <div>
		          	...
		          	<a id="to_google_link mobile_disappear" className="hide" href="/api/logout">
						<button type="button" className="btn btn-outline-info google_signin_button"><i className="fab fa-google-plus-g fa-2x"></i>  Click To Sign-Out! </button>
					</a>
				</div>
          	);
	...
	render() {
		return (
			<div>
		        <Navbar className="nav_nav" color="faded" light>
		          <h3 className="mr-auto">Mail Me Back Email Forwarding - Survey Dashboard {this.renderPayment()}</h3>
		          ...
		          <Collapse isOpen={!this.state.collapsed} navbar>
		            ...
		            <NavItem>
		              ...
		              <NavItem>
		                <NavLink href="/surveys/new">Create A Survey</NavLink>
		              </NavItem>
		              <NavItem>
		              	{this.renderContent()}
		              </NavItem>
...
export default connect(mapStateToProps, {  })(NavbarSurveys);