...
class NavbarSurveysNew extends Component {
constructor(props) {
    super(props);
		...
		return (
			<div>
		        <Navbar className="nav_nav" color="faded" light>
		          <h3 className="mr-auto">Mail Me Back Email Forwarding - Create A Survey{this.renderPayment()}</h3>
...
export default connect(mapStateToProps, {  })(NavbarSurveysNew);